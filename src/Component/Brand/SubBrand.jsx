...
export default function SubBrand() {
    ...
    async function getProductsOfSpecificBrand() {
        setloading(true)
        let { data } = await axios.get(baseURl + `products?brand=${id}`);
        setloading(false)
            ...
            {loading ? <Loading /> : <div>
                <div className="container">
                    <div className="row mt-5">
                        {
                            products != '' ? products.map((elm) => <div className="col-md-2 m-auto">
                                <div className="product-info cursor-pointer text-center product">
                                    <Link className='nav-link' to={"/details/" + elm._id}>
                                        ...
                                        <p className='fw-bolder text-start text-main'>{elm.title.split(" ").slice(0, 2).join(" ")}</p>
                                ...
                                <div className="col-md-6 m-auto mt-5">
                                    <div className="noProduct ">
                                        ...
                                        <h6 className='h3 text-center fw-bolder'>This brand Dos not have Products currently</h6>
                                    </div>
                                </div>
                            </div>
